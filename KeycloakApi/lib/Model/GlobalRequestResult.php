...
/**
 * GlobalRequestResult Class Doc Comment
 *
 * @category Class
 * @package  WebMI\KeycloakApiClient\KeycloakApi
 * @author   OpenAPI Generator team
 ...
 */
class GlobalRequestResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GlobalRequestResult';
    ...
    {
        $this->setIfExists('success_requests', $data ?? [], null);
    ...
    */
    ...
    /**
     * Sets success_requests
     *
     * @param string[]|null $success_requests success_requests
     *
     * @return self
     */
    public function set_success_requests($success_requests)
    {
        ...
        $this->container['success_requests'] = $success_requests;
     ...
     *
     * @param string[]|null $failed_requests failed_requests
     *
     * @return self
     */
