...
/**
 * MappingsRepresentation Class Doc Comment
 *
 * @category Class
 * @package  WebMI\KeycloakApiClient\KeycloakApi
 * @author   OpenAPI Generator team
 ...
 */
class MappingsRepresentation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MappingsRepresentation';
    ...
    protected static $openAPITypes = [
        'realm_mappings' => '\WebMI\KeycloakApiClient\KeycloakApi\Model\RoleRepresentation[]',
        'client_mappings' => 'array<string,\WebMI\KeycloakApiClient\KeycloakApi\Model\ClientMappingsRepresentation>'
    ];
    ...
    {
        $this->setIfExists('realm_mappings', $data ?? [], null);
    ...
    */
     ...
     * Sets realm_mappings
     *
     * @param \WebMI\KeycloakApiClient\KeycloakApi\Model\RoleRepresentation[]|null $realm_mappings realm_mappings
     *
     * @return self
     */
    public function setRealmMappings($realm_mappings)
    {
        ...
        $this->container['realm_mappings'] = $realm_mappings;
     ...
     *
     * @param array<string,\WebMI\KeycloakApiClient\KeycloakApi\Model\ClientMappingsRepresentation>|null $client_mappings client_mappings
     *
     * @return self
     */
