...
/**
 * SocialLinkRepresentation Class Doc Comment
 *
 * @category Class
 * @package  WebMI\KeycloakApiClient\KeycloakApi
 * @author   OpenAPI Generator team
 ...
 */
class SocialLinkRepresentation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SocialLinkRepresentation';
    ...
    {
        $this->setIfExists('social_provider', $data ?? [], null);
        $this->setIfExists('social_user_id', $data ?? [], null);
        $this->setIfExists('social_username', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Sets social_provider
     *
     * @param string|null $social_provider social_provider
     *
     * @return self
     */
    public function setSocialProvider($social_provider)
    {
        ...
        $this->container['social_provider'] = $social_provider;
     ...
     * Sets social_user_id
     *
     * @param string|null $social_user_id social_user_id
     *
     * @return self
     */
    public function setSocialUserId($social_user_id)
    {
        ...
        $this->container['social_user_id'] = $social_user_id;
    ...
    /**
     * Sets social_username
     *
     * @param string|null $social_username social_username
     *
     * @return self
     */
    public function setSocialUsername($social_username)
    {
        ...
        $this->container['social_username'] = $social_username;
