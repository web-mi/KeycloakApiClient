...
class Permission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('rsid', $data ?? [], null);
        $this->setIfExists('rsname', $data ?? [], null);
    ...
    */
     ...
     * Sets rsname
     *
     * @param string|null $rsname rsname
     *
     * @return self
     */
     ...
     * Sets claims
     *
     * @param array<string,string[]>|null $claims claims
     *
     * @return self
     */
