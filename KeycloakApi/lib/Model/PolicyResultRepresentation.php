...
/**
 * PolicyResultRepresentation Class Doc Comment
 *
 * @category Class
 * @package  WebMI\KeycloakApiClient\KeycloakApi
 * @author   OpenAPI Generator team
 ...
 */
class PolicyResultRepresentation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PolicyResultRepresentation';
    ...
    protected static $openAPITypes = [
        'policy' => '\WebMI\KeycloakApiClient\KeycloakApi\Model\PolicyRepresentation',
        'status' => '\WebMI\KeycloakApiClient\KeycloakApi\Model\DecisionEffect',
        'associated_policies' => '\WebMI\KeycloakApiClient\KeycloakApi\Model\PolicyResultRepresentation[]',
        'scopes' => 'string[]'
    ];
    ...
    protected static $attributeMap = [
        'policy' => 'policy',
        'status' => 'status',
        'associated_policies' => 'associatedPolicies',
        'scopes' => 'scopes'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('associated_policies', $data ?? [], null);
    ...
    */
     ...
     * Sets policy
     *
     * @param \WebMI\KeycloakApiClient\KeycloakApi\Model\PolicyRepresentation|null $policy policy
     *
     * @return self
     */
    ...
    /**
     * Sets associated_policies
     *
     * @param \WebMI\KeycloakApiClient\KeycloakApi\Model\PolicyResultRepresentation[]|null $associated_policies associated_policies
     *
     * @return self
     */
    public function set_associated_policies($associated_policies)
    {
        ...
        $this->container['associated_policies'] = $associated_policies;
