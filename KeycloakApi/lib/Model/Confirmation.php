...
class Confirmation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('x5t_s256', $data ?? [], null);
        $this->setIfExists('jkt', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets x5t_s256
     *
     * @param string|null $x5t_s256 x5t_s256
     *
     * @return self
     */
    public function set_x5t_s256($x5t_s256)
    {
        ...
        $this->container['x5t_s256'] = $x5t_s256;
