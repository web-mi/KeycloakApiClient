...
class UsersApi
{
     ...
     * @param  string|null $email email filter (optional)
     * @param  bool|null $email_verified email_verified (optional)
     * @param  bool|null $enabled Boolean representing if user is enabled or not (optional)
     * @param  string|null $first_name first name filter (optional)
     * @param  string|null $last_name last name filter (optional)
     * @param  string|null $q q (optional)
     * @param  string|null $search arbitrary search string for all the fields below. Default search behavior is prefix-based (e.g., foo or foo*). Use *foo* for infix search and \&quot;foo\&quot; for exact search. (optional)
     * @param  string|null $username username filter (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string|null $email email filter (optional)
     * @param  bool|null $email_verified (optional)
     * @param  bool|null $enabled Boolean representing if user is enabled or not (optional)
     * @param  string|null $first_name first name filter (optional)
     * @param  string|null $last_name last name filter (optional)
     ...
     *
     * @param  string $realm realm name (not id!) (required)
     * @param  bool|null $brief_representation Boolean which defines whether brief representations are returned (default: false) (optional)
     * @param  string|null $email A String contained in email, or the complete email, if param \&quot;exact\&quot; is true (optional)
     * @param  bool|null $email_verified whether the email has been verified (optional)
     * @param  bool|null $enabled Boolean representing if user is enabled or not (optional)
     * @param  bool|null $exact Boolean which defines whether the params \&quot;last\&quot;, \&quot;first\&quot;, \&quot;email\&quot; and \&quot;username\&quot; must match exactly (optional)
     * @param  int|null $first Pagination offset (optional)
     * @param  string|null $first_name A String contained in firstName, or the complete firstName, if param \&quot;exact\&quot; is true (optional)
     * @param  string|null $idp_alias The alias of an Identity Provider linked to the user (optional)
     * @param  string|null $idp_user_id The userId at an Identity Provider linked to the user (optional)
     * @param  string|null $last_name A String contained in lastName, or the complete lastName, if param \&quot;exact\&quot; is true (optional)
     * @param  int|null $max Maximum results size (defaults to 100) (optional)
     * @param  string|null $q A query to search for custom attributes, in the format &#39;key1:value2 key2:value2&#39; (optional)
     * @param  string|null $search A String contained in username, first or last name, or email. Default search behavior is prefix-based (e.g., foo or foo*). Use *foo* for infix search and \&quot;foo\&quot; for exact search. (optional)
     * @param  string|null $username A String contained in username, or the complete username, if param \&quot;exact\&quot; is true (optional)
     ...
     *
     * @param  string $realm realm name (not id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\UserRepresentation|null $user_representation user_representation (optional)
     ...
     *
     * @param  string $realm realm name (not id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\UserRepresentation|null $user_representation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmUsersPost'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $realm realm name (not id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\UPConfig|null $up_config up_config (optional)
     ...
     *
     * @param  string $realm realm name (not id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\UPConfig|null $up_config (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmUsersProfilePut'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  int|null $lifespan Number of seconds after which the generated token expires (optional)
     * @param  string|null $redirect_uri Redirect uri (optional)
     * @param  string[]|null $request_body request_body (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $user_id user_id (required)
     * @param  bool|null $user_profile_metadata Indicates if the user profile metadata should be added to the response (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $user_id user_id (required)
     * @param  bool|null $brief_representation brief_representation (optional, default to true)
     * @param  int|null $first first (optional)
     * @param  int|null $max max (optional)
     * @param  string|null $search search (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $user_id (required)
     * @param  bool|null $brief_representation (optional, default to true)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $user_id user_id (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\CredentialRepresentation|null $credential_representation credential_representation (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $user_id (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\CredentialRepresentation|null $credential_representation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmUsersUserIdResetPasswordPut'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
