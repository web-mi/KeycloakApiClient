...
class ClientsApi
{
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\ClientRepresentation|null $client_representation client_representation (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\ClientRepresentation|null $client_representation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmClientsClientUuidPut'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $realm realm name (not id!) (required)
     * @param  string|null $client_id filter by clientId (optional)
     * @param  int|null $first the first result (optional)
     * @param  int|null $max the max results to return (optional)
     * @param  string|null $q q (optional)
     * @param  bool|null $search whether this is a search query or a getClientById query (optional, default to false)
     * @param  bool|null $viewable_only filter clients that cannot be viewed in full by admin (optional, default to false)
