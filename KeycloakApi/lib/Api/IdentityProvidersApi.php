...
class IdentityProvidersApi
{
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $alias alias (required)
     * @param  string|null $format Format to use (optional)
     ...
     * @param  string $alias alias (required)
     * @param  string $id Mapper id (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\IdentityProviderMapperRepresentation|null $identity_provider_mapper_representation identity_provider_mapper_representation (optional)
     ...
     * @param  string $alias (required)
     * @param  string $id Mapper id (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\IdentityProviderMapperRepresentation|null $identity_provider_mapper_representation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmIdentityProviderInstancesAliasMappersIdPut'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $alias alias (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\IdentityProviderRepresentation|null $identity_provider_representation identity_provider_representation (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $alias (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\IdentityProviderRepresentation|null $identity_provider_representation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmIdentityProviderInstancesAliasPut'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  bool|null $realm_only Boolean which defines if only realm-level IDPs (not associated with orgs) should be returned (default: false) (optional)
     * @param  string|null $search Filter specific providers by name. Search can be prefix (name*), contains (*name*) or exact (\&quot;name\&quot;). Default prefixed. (optional)
