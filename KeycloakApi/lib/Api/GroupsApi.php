...
class GroupsApi
{
     ...
     * @param  bool|null $top top (optional, default to false)
     ...
     * @param  bool|null $top (optional, default to false)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmGroupsCountGet'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  bool|null $exact exact (optional, default to false)
     * @param  int|null $first first (optional)
     * @param  int|null $max max (optional)
     * @param  bool|null $populate_hierarchy populate_hierarchy (optional, default to true)
     ...
     * @param  bool|null $exact (optional, default to false)
     * @param  int|null $first (optional)
     * @param  int|null $max (optional)
     * @param  bool|null $populate_hierarchy (optional, default to true)
     ...
     * @param  bool|null $brief_representation Boolean which defines whether brief groups representations are returned or not (default: false) (optional, default to false)
     * @param  bool|null $exact Boolean which defines whether the params \&quot;search\&quot; must match exactly or not (optional)
     * @param  int|null $first The position of the first result to be returned (pagination offset). (optional)
     * @param  int|null $max The maximum number of results that are to be returned. Defaults to 10 (optional)
     * @param  string|null $search A String representing either an exact group name or a partial name (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $group_id group_id (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\GroupRepresentation|null $group_representation group_representation (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $group_id (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\GroupRepresentation|null $group_representation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmGroupsGroupIdChildrenPost'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $group_id group_id (required)
     * @param  bool|null $brief_representation Only return basic information (only guaranteed to return id, username, created, first and last name, email, enabled state, email verification state, federation link, and access. Note that it means that namely user attributes, required actions, and not before are not returned.) (optional)
