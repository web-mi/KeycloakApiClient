...
class OrganizationsApi
{
     ...
     * @param  bool|null $brief_representation if true, return the full representation. Otherwise, only the basic fields are returned. (optional, default to false)
     * @param  bool|null $exact Boolean which defines whether the param &#39;search&#39; must match exactly or not (optional)
     * @param  int|null $first The position of the first result to be processed (pagination offset) (optional)
     * @param  int|null $max The maximum number of results to be returned - defaults to 10 (optional)
     * @param  string|null $q A query to search for custom attributes, in the format &#39;key1:value2 key2:value2&#39; (optional)
     * @param  string|null $search A String representing either an organization name or domain (optional)
     ...
     * @param  int|null $first The position of the first result to be processed (pagination offset) (optional)
     * @param  int|null $max The maximum number of results to be returned. Defaults to 10 (optional)
     * @param  string|null $membership_type The membership type (optional)
     * @param  string|null $search A String representing either a member&#39;s username, e-mail, first name, or last name. (optional)
    ...
    public function adminRealmsRealmOrganizationsIdMembersInviteExistingUserPostRequest($realm, $id, $id2 = null, string $contentType = self::contentTypes['adminRealmsRealmOrganizationsIdMembersInviteExistingUserPost'][0])
    {
        ...
        // form params
        if ($id2 !== null) {
            $formParams = array_merge($formParams, ObjectSerializer::toFormValue('id', $id2));
        }
    ...
    public function adminRealmsRealmOrganizationsIdMembersInviteUserPostRequest($realm, $id, $email = null, $first_name = null, $last_name = null, string $contentType = self::contentTypes['adminRealmsRealmOrganizationsIdMembersInviteUserPost'][0])
    {
        ...
        // form params
        if ($email !== null) {
            $formParams = array_merge($formParams, ObjectSerializer::toFormValue('email', $email));
        }
        // form params
        if ($first_name !== null) {
            $formParams = array_merge($formParams, ObjectSerializer::toFormValue('firstName', $first_name));
        }
        // form params
        if ($last_name !== null) {
            $formParams = array_merge($formParams, ObjectSerializer::toFormValue('lastName', $last_name));
        }
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $id id (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\OrganizationRepresentation|null $organization_representation organization_representation (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $id (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\OrganizationRepresentation|null $organization_representation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmOrganizationsIdPut'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
