...
class RolesApi
{
     ...
     * @param  string|null $search search (optional, default to '')
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\RoleRepresentation|null $role_representation role_representation (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\RoleRepresentation|null $role_representation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmClientsClientUuidRolesPost'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  bool|null $brief_representation if false, return a full representation of the {@code GroupRepresentation} objects. (optional, default to true)
     * @param  int|null $first first result to return. Ignored if negative or {@code null}. (optional)
     * @param  int|null $max maximum number of results to return. Ignored if negative or {@code null}. (optional)
