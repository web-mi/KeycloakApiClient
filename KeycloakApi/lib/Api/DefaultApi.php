...
class DefaultApi
{
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\ResourceServerRepresentation|null $resource_server_representation resource_server_representation (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\ResourceServerRepresentation|null $resource_server_representation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmClientsClientUuidAuthzResourceServerImportPost'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\PolicyEvaluationRequest|null $policy_evaluation_request policy_evaluation_request (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\PolicyEvaluationRequest|null $policy_evaluation_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmClientsClientUuidAuthzResourceServerPermissionEvaluatePost'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  bool|null $permission permission (optional)
     * @param  string|null $policy_id policy_id (optional)
     ...
     * @param  bool|null $permission (optional)
     * @param  string|null $policy_id (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  string|null $_id _id (optional)
     * @param  bool|null $deep deep (optional)
     * @param  bool|null $exact_name exact_name (optional)
     * @param  int|null $first first (optional)
     * @param  bool|null $matching_uri matching_uri (optional)
     * @param  int|null $max max (optional)
     * @param  string|null $name name (optional)
     * @param  string|null $owner owner (optional)
     * @param  string|null $scope scope (optional)
     * @param  string|null $type type (optional)
     * @param  string|null $uri uri (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  string|null $_id (optional)
     * @param  bool|null $deep (optional)
     * @param  bool|null $exact_name (optional)
     * @param  int|null $first (optional)
     * @param  bool|null $matching_uri (optional)
     * @param  int|null $max (optional)
     * @param  string|null $name (optional)
     * @param  string|null $owner (optional)
     * @param  string|null $scope (optional)
     ...
     * @param  string|null $type type (optional)
     * @param  string|null $uri uri (optional)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\ResourceRepresentation|null $resource_representation resource_representation (optional)
     ...
     * @param  string|null $type (optional)
     * @param  string|null $uri (optional)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\ResourceRepresentation|null $resource_representation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmClientsClientUuidAuthzResourceServerResourcePost'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  int|null $max max (optional)
     * @param  string|null $name name (optional)
     * @param  string|null $scope_id scope_id (optional)
     ...
     * @param  int|null $max (optional)
     * @param  string|null $name (optional)
     * @param  string|null $scope_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmClientsClientUuidAuthzResourceServerScopeGet'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\ScopeRepresentation|null $scope_representation scope_representation (optional)
     ...
     * @param  string $realm realm name (not id!) (required)
     * @param  string $client_uuid id of client (not client-id!) (required)
     * @param  \WebMI\KeycloakApiClient\KeycloakApi\Model\ScopeRepresentation|null $scope_representation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['adminRealmsRealmClientsClientUuidAuthzResourceServerScopePost'] to see the possible values for this operation
     *
     * @throws \WebMI\KeycloakApiClient\KeycloakApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
